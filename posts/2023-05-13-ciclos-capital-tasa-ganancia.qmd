...
author: "Norberto Bustos"
date: 2023-05-13
categories: [economía política]
description: "Análisis de las teorías de los ciclos económicos clásicos, las ondas largas y la tendencia a la baja de la tasa de ganancia en el pensamiento económico."
image: ""
---
...
ggplot(df, aes(x = tiempo, y = pib)) +
  ...
  geom_line(color = "#00008B", linewidth = 1.2) +
  ...
  labs(x = "Tiempo", 
       ...
       fill = NULL,
       caption = "Elaborado por n0dn, 2023") +
  theme_minimal() +
  theme(
