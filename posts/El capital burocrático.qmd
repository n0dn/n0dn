---
title: "Acercamiento a la definición del capital burocrático"
author: "Dr. Norberto Bustos"
date: "2023-09-14"
categories: [teoría, capital burocrático]
description: "Introducción del capital burocrático"
image: "/images/Mex_full_rpm.png"
format: 
  html: 
    toc: true
    toc-title: "Contenido"
...
## El capital político como indicador
...
Siguiendo este principio, la clasificación del capital político en función de su cercanía al Estado nos permite entender la diversidad en el capital político de un individuo o grupo, tanto dentro como fuera del aparato estatal @tbl-posiciones-estado
...
datos <- data.frame(
  Posicion = c("Interno", "Interno", "Interno", "Externa", "Externa"),
  ...
  Cargos = c(
    "Presidente, Vicepresidente, Ministros, Embajadores, Directivos de banca estatal.",
    "Gobernadores, Diputados, Senadores, Jueces, Magistrados, Militares.",
    "Alcaldes, líderes de partidos políticos, estructuras y grupos anexos.",
    "Empresarios, banqueros, gremios industriales, comerciantes, líderes sindicales.",
    "Movimientos insurgentes, revolucionarios o grupos paramilitares."
  )
)

# 2. Generar la tabla con kable y kableExtra
datos %>%
  kable(
    col.names = c("Posición respecto al aparato de Estado", "Clase", "Descripción", "Cargos"),
    align = "ccll",
    booktabs = TRUE
  ) %>%
  kable_styling(
...
## 2. Centralidad en la complejidad de la red política
...
![Red Política de México, Elaborado por n0dn, 2023](/images/Mex_full_rpm.png){fig-alt="Red Política Histórica de los gobernantes de México (1821-2018)" fig-align="center"}
